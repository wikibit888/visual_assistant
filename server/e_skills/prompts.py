...
# ── 以下键 M1-10 不动，留占位给后续里程碑（保持可 import、不报错）──
OUTFIT_STYLE = ""          # 穿搭建议（结合天气、具体到行动）——归 M3-06
SUMMARY_STYLE = ""         # 口头小结（做了几道、卡点、提醒坐姿几次）——归 M3-06
OPEN_STYLE = ""            # 开放对话（无预设 + 诚实兜底 + 期望管理话术，PRD §5.4）——归 M3-06
ANSWER_GUARD_TRIGGERS: list[str] = []  # 答案护栏触发词（配合数值组合正则，契约九）——归 M2-07
